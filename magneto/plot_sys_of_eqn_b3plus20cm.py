...
mydata = np.genfromtxt('experiment_201810_040509_b3_plus20/RESULTS/20SEC/mydata.csv', delimiter=',', dtype=None, names=('beacon', 'u_sensor', 'b_sensor', 'tstart', 'tend', 'degree'))
