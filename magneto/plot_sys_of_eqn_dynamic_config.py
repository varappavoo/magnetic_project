...
def compute_sensor_location(b ,s, myfile, b3distace=0, plot_it=0, lstsq=1, gt=0):
	A=[]
	B=[]
	M={} # gradients
	D={} # degrees
...
def compute_ground_truth(ground_truth_file):
	for i in range(10):
		s = "s" + str(i+1)
		u_x, u_y = compute_sensor_location(['b1','b2','b3','b4'] ,s, ground_truth_file, plot_it=0, gt=1, lstsq=1)
		sx.append(u_x)
		sy.append(u_y)
...
# plt.sh
# print("b",b)
u_x, u_y = compute_sensor_location(b ,s, myfile, b3distace, plot_it, lstsq=1)
