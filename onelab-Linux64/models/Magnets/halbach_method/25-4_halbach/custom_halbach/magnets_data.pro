...
For i In {1:NumMagnets}
	...
	count = count +1;
		...
		// NORTH UP
	If((count + 1) == 2 || (count + 1) == 3 || (count + 1) == 4)
		DefineConstant[
	...
	// SOUTH FACING RIGHT/ NORTH FACING LEFT
	If((count + 1) == 5)
	...
	// SOUTH FACING LEFT/ NORTH FACING RIGHT
	If((count + 1) == 1)
...
/*
	...
	*/
	...
	/*
	// SOUTH FACING FRONT/ NORTH FACING BACK
	...
	// SOUTH FACING BACK/ NORTH FACING FRONT
