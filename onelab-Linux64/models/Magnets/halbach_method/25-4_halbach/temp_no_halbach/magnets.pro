...
*/
    ...
    Print[ b,   OnBox {{-0.4, -0.4, -0.4}{-0.4, -0.4, 0.4} {-0.4, 0.4, -0.4} {0.4, -0.4, -0.4}}{200,200,200}, File >"b_box.dat.csv", Format Gnuplot ];
    Print[ bm,  OnBox {{-0.4, -0.4, -0.4}{-0.4, -0.4, 0.4} {-0.4, 0.4, -0.4} {0.4, -0.4, -0.4}}{200,200,200}, File >"bm_box.dat.csv", Format Gnuplot ];
