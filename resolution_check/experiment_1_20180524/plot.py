...
########################################
s1_mov_avg -= s1_mov_avg.mean(); s1_mov_avg /= s1_mov_avg.std()
s2_mov_avg -= s2_mov_avg.mean(); s2_mov_avg /= s2_mov_avg.std()
...
print(colored("time shift:" + str(time_shift), "yellow"))
...
plt.plot(s2_t[peaks_sci_s1], s2_mov_avg[peaks_sci_s2], "x")
