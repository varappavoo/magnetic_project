...
peak_width = 1000
mean_samples = 1
SMOOTH_CUT_OFF_FREQ_W_S0 = 1#0.2
SMOOTH_CUT_OFF_FREQ_W_S1 = 0.04#0.08 # 0.08 seems fine for a period of approx 30sec with frame of size 60secs
WAVELET = 0
PERIOD_APPROX = 28000
...
def loop(truncate_start, truncate_end):
	...
	for ground_truth_stag in ground_truth_stags:
		for unknown_stag in unknown_stags:
			time_shift, period_s0 = process_data(ground_truth_stags_data[ground_truth_stag], unknown_stags_data[unknown_stag], truncate_start, truncate_end, SMOOTH_CUT_OFF_FREQ_W_S1, SMOOTH_CUT_OFF_FREQ_W_S0,ground_truth_stag, unknown_stag, False)
			# print("-----------------------------------------------------------------")
...
# CW
ground_truth_stags = ['s0_1_0','s0_2','s0_3','s0_4','s0_5']
