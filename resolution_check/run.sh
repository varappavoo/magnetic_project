...
~/contiki-magnetometer-nicholasinatel/contiki/tools/sky/serialdump-linux -b115200 $device|ts "%.s"|awk {'print $1,$2/100,$3/100,$4/100,sqrt($2*$2+$3*$3+$4*$4)/100;fflush();'}|awk 'NR>500;fflush();'|tee $filename
