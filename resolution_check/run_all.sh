#!/bin/bash
experiment=$1
./run.sh /dev/serial/by-id/usb-Texas_Instruments_XDS110__02.03.00.12__Embed_with_CMSIS-DAP_L1498-if00 "s0_1_$experiment.dat" 2>/dev/null &
./run.sh /dev/serial/by-id/usb-Texas_Instruments_XDS110__02.03.00.12__Embed_with_CMSIS-DAP_L1188-if00 "s2_$experiment.dat" 2>/dev/null &
